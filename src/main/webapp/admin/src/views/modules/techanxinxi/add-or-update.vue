          ...
          <el-form-item class="input" label="品牌" prop="pinpai">
              <el-input v-model="ruleForm.pinpai" 
                placeholder="品牌" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="产区" prop="chanqu">
          <el-input v-model="ruleForm.chanqu" 
              placeholder="产区" clearable  :readonly="ro.chanqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="产区" prop="chanqu">
              <el-input v-model="ruleForm.chanqu" 
                placeholder="产区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                              <el-col :span="12">
